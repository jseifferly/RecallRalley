game      call    clear_screen         clear_ra
          ...
          call    RandomArray          r_ret_arraygame      call    clear_screen         clear_ra
          call    menu                 menu_ra
          cp      game_diff            menu_diff
          cp      random_difficulty    game_diff
...
g_pass    bne       g_lose             game_sent       game_pass
          cp        game_decision      game_num1
          cp        driver_send_arr    game_num1
          cp        driver_send_length game_num1
          call      serialsend         driver_send_ret
          be        g_continue         0               0

g_lose    cp        game_decision      game_num2  
          cp        driver_send_arr    game_num2
          cp        driver_send_length game_num1
          call      serialsend         driver_send_ret 
          be        g_continue         0               0  

g_doublelose cp     game_decision      game_num3
             cp     driver_send_arr    game_num3
             cp     driver_send_length game_num1
             call   serialsend         driver_send_ret 
             be     g_continue         0               0
       
g_win        cp     driver_send_arr    game_num3
             cp     driver_send_length game_num1
             call   serialsend         driver_send_ret           
